...
$route['member/requested-loa/closed'] = 'member/pages_controller/closed_requested_loa';
...
$route['member/requested-noa/closed'] = 'member/pages_controller/closed_requested_noa';
...
$route['member/requested-loa/closed/fetch'] = 'member/loa_controller/fetch_closed_loa';
...
$route['member/requested-noa/closed/fetch'] = 'member/noa_controller/fetch_closed_noa';
...
$route['member/requested-noa/view/closed/(:any)'] = 'member/noa_controller/get_closed_noa_info';
...
$route['healthcare-provider/billing/bill-loa/(:any)/success'] = 'healthcare_provider/billing_controller/loa_billing_success';
...
$route['healthcare-provider/noa-requests/closed'] = 'healthcare_provider/pages_controller/closed_noa_requests';
...
$route['healthcare-provider/noa-requests/closed/fetch'] = 'healthcare_provider/noa_controller/fetch_closed_noa_requests';
...
$route['healthcare-coordinator/loa/requests-list/closed'] = 'healthcare_coordinator/pages_controller/view_closed_loa_list';
...
$route['healthcare-coordinator/noa/requests-list/closed'] = 'healthcare_coordinator/pages_controller/view_closed_noa_list';
...
$route['healthcare-coordinator/loa/requests-list/closed/fetch'] = 'healthcare_coordinator/loa_controller/fetch_all_closed_loa';
...
$route['healthcare-coordinator/loa/closed/view/(:any)'] = 'healthcare_coordinator/loa_controller/get_closed_loa_info';
...
$route['healthcare-coordinator/noa/requests-list/closed/fetch'] = 'healthcare_coordinator/noa_controller/fetch_all_closed_noa';
...
$route['healthcare-coordinator/noa/closed/view/(:any)'] = 'healthcare_coordinator/noa_controller/get_closed_noa_info';
