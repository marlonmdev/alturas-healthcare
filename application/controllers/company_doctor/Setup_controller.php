...
class Setup_controller extends CI_Controller {
  ...
  function register_affiliate_hospital(){
    ...
    if($this->form_validation->run() == FALSE){
      ...
      if($saved){
        $response = ['status' => 'success', 'message' => 'Affiliate Hospital Saved Successfully!'];
      }else{
        $response = ['status' => 'save-error', 'message' => 'Affiliate Hospital Saved Failed!'];
      }			
  ...
  function check_hospital_name_exist($hospital_name){
  ...
  function edit_affiliate_hospital(){
