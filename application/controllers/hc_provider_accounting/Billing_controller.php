...
class Billing_controller extends CI_Controller {
    ...
    function billing_search_member() {
        ...
        $this->load->view('hc_provider_accounting_panel/billing/search_member');
    ...
    function search_member_by_name() {
        ...
        if (!$member) {
            ...
            $this->load->view('templates/header', $data);
            $this->load->view('hc_provider_accounting_panel/billing/search_member_result');
            $this->load->view('templates/footer');
        }
    }
    ...
    function bill_patient_loa() {
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('hc_provider_accounting_panel/billing/'.$view_page);
        $this->load->view('templates/footer');
    }
    ...
    function loa_billing_success(){
		...
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_accounting_panel/billing/billing_success');
		$this->load->view('templates/footer');
    }
    ...
    function bill_patient_noa() {
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('hc_provider_accounting_panel/billing/bill_patient_noa');
        $this->load->view('templates/footer');
    }
    ...
    function upload_loa_pdf_bill_form() {
		...
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_accounting_panel/billing/upload_loa_bill_pdf');
		$this->load->view('templates/footer');
	}
    ...
    function pdf_billing_success(){
        ...
        $data['bill'] = $bill = $this->billing_model->get_billing_info($billing_id);
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_accounting_panel/billing/pdf_billing_success');
		$this->load->view('templates/footer');
    }
	...
	function upload_noa_pdf_bill_form() {
		...
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_accounting_panel/billing/upload_noa_bill_pdf');
		$this->load->view('templates/footer');
	}
