...
class Pages_controller extends CI_Controller {
	...
	function index() {
		...
		$this->load->view('hc_provider_front_desk_panel/dashboard/index');
	...
	function pending_loa_requests() {
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/loa/pending_loa_list');
		$this->load->view('templates/footer');
	}
	...
	function approved_loa_requests() {
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/loa/approved_loa_list');
		$this->load->view('templates/footer');
	}
	...
	function disapproved_loa_requests() { 
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/loa/disapproved_loa_list');
		$this->load->view('templates/footer');
	}
	...
	function completed_loa_requests() {
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/loa/completed_loa_list');
		$this->load->view('templates/footer');
	}
	...
	function billed_loa_requests() {
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/loa/billed_loa_list');
		$this->load->view('templates/footer');
	}
	...
	function pending_noa_requests() {
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/noa/pending_noa_list');
		$this->load->view('templates/footer');
	}
	...
	function approved_noa_requests() {
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/noa/approved_noa_list');
		$this->load->view('templates/footer');
	}
	...
	function disapproved_noa_requests() {
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/noa/disapproved_noa_list');
		$this->load->view('templates/footer');
	}
	...
	function completed_noa_requests() {
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/noa/completed_noa_list');
		$this->load->view('templates/footer');
	}
	...
	function billed_noa_requests() {
		$data['user_role'] = $this->session->userdata('user_role');
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/noa/billed_noa_list');
		$this->load->view('templates/footer');
	}
	...
	function payment_list() {
		...
		$this->load->view('templates/header', $data);
		$this->load->view('hc_provider_front_desk_panel/billing/payment_list.php',$hcare_provider);
		$this->load->view('templates/footer');
	}
}
