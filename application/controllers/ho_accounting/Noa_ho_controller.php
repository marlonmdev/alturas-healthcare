...
class Noa_ho_controller extends CI_Controller {
    ...
    public function get_all_noa() {
        ...
        // //loa_member
        $this->load->view('templates/header', $data);
        $this->load->view('ho_accounting_panel/noa_billing_list/noa_list_accounting.php', array('members' => $members));
        $this->load->view('templates/footer');
    }
}
