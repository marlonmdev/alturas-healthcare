...
class Members_model extends CI_Model {
  ...
  // function db_get_all_pending_members() {
  //   $this->db->select('member_id, emp_id, first_name, middle_name, last_name, suffix, gender, position, emp_type, current_status, business_unit, dept_name, approval_status');
  ...
  // function db_get_all_approved_members() {
  //   $this->db->select('member_id, emp_id, first_name, middle_name, last_name, suffix, gender, position, emp_type, current_status, business_unit, dept_name, approval_status');
  //   $this->db->from('members');
