...
class Loa_model extends CI_Model {
  ...
  function db_get_approved_loa($emp_id) {
    $this->db->select('tbl_1.loa_id, tbl_1.loa_no, tbl_2.hp_name, tbl_1.loa_request_type, tbl_1.med_services, tbl_1.rx_file, tbl_1.work_related, tbl_1.request_date, tbl_1.approved_on, tbl_1.status')
             ->from('loa_requests as tbl_1')
             ->join('healthcare_providers as tbl_2', 'tbl_1.hcare_provider = tbl_2.hp_id')
