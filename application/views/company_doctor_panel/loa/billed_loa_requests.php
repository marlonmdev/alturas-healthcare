    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="nav nav-tabs mb-4" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>company-doctor/loa/requests-list/billed" role="tab">
              <span class="hidden-sm-up"></span>
...
<script>
    ...
    $(document).ready(function() {
        ...
        let billedTable = $('#billedLoaTable').DataTable({
            ...
            ajax: {
                url: `${baseUrl}company-doctor/loa/requests-list/billed/fetch`,
                type: "POST",
