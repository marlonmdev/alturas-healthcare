    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>hc-provider-accounting/loa-requests/pending" role="tab">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>hc-provider-accounting/loa-requests/approved" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>hc-provider-accounting/loa-requests/disapproved" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>hc-provider-accounting/loa-requests/completed" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>hc-provider-accounting/loa-requests/billed" role="tab">
              <span class="hidden-sm-up"></span>
              ...
              <table id="approvedLoaTable" class="table table-striped">
                <thead style="background-color:#00538C">
                  <tr>
                    ...
                    <th class="fw-bold" style="color: white">SERVICE/s</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#approvedLoaTable').DataTable({
            ...
            ajax: {
                url: `${baseUrl}hc-provider-accounting/loa-requests/approved/fetch`,
                type: "POST",
    ...
    function viewLoaInfo(loa_id) {
        $.ajax({
        url: `${baseUrl}hc-provider-accounting/loa-requests/approved/view/${loa_id}`,
        type: "GET",
        success: function(response) {
            ...
            request_date, chief_complaint, requesting_physician, attending_physician, rx_file,
            req_status, work_related, approved_by, approved_on,percentage
            } = res;
            ...
            $('#hc-provider-accounting').html(healthcare_provider);
