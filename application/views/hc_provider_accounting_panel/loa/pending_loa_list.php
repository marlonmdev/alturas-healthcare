    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>hc-provider-accounting/loa-requests/pending" role="tab">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#pendingLoaTable').DataTable({
            ...
            ajax: {
                url: `${baseUrl}hc-provider-accounting/loa-requests/pending/fetch`,
                type: "POST",
    ...
    function viewLoaInfo(loa_id) {
        $.ajax({
            url: `${baseUrl}hc-provider-accounting/loa-requests/pending/view/${loa_id}`,
            type: "GET",
