    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>hc-provider-accounting/noa-requests/pending" role="tab">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>hc-provider-accounting/noa-requests/billed" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <!-- <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>hc-provider-accounting/noa-requests/completed" role="tab">
              <span class="hidden-sm-up"></span>
...
<script>
    ...
    $(document).ready(function() {
        ...
        ajax: {
            url: `${baseUrl}hc-provider-accounting/noa-requests/pending/fetch`,
            type: "POST",
    ...
    function viewNoaInfo(noa_id) {
        $.ajax({
            url: `${baseUrl}hc-provider-accounting/noa-requests/view/${noa_id}`,
            type: "GET",
