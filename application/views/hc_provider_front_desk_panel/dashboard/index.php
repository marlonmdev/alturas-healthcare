          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card-box bg-orange">
                ...
                <a href="<?php echo base_url() ?>hc-provider-front-desk/loa-requests/approved" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card-box bg-red">
                ...
                <a href="<?php echo base_url() ?>hc-provider-front-desk/noa-requests/approved" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card-box bg-blue">
                ...
                <a href="<?php echo base_url() ?>hc-provider-front-desk/patient/design" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
    ...
    <script>
      ...
      $(document).ready(function(){
        ...
        $("#search-form-2").on('submit', function(event){
          ...
          //     ajax: {
          //       url: `${base_url}hc-provider-front-desk/patient/fetch_all_patient_loa`,
          //       type: "POST",
          ...
          //   ajax: {
          //     url: `${base_url}hc-provider-front-desk/patient/fetch_all_patient_noa`,
          //     type: "POST",
          //     data: { 'token' : '<?php echo $this->security->get_csrf_hash(); ?>',
          //             'emp_id' :  emp_id,
          //             'hp_id' :  hp_id}
    ...
    //     $.ajax({
    //     url: `${base_url}hc-provider-front-desk/patient_history/loa/${loa_no}`,
    //     type: "GET",
    ...
    //     $.ajax({
    //     url: `${base_url}hc-provider-front-desk/patient_history/noa/${noa_id}`,
    //     type: "GET",
    //     success: function(response) {
    //         const res = JSON.parse(response);
