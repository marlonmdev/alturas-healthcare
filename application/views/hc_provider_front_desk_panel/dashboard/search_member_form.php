    ...
    <div class="card shadow">
      ...
      <div class="card-body">
        ...
        <div class="col-6 offset-3 mb-5 d-none" id="search-by-healthcard">
          <form method="POST" action="<?php echo base_url(); ?>hc-provider-front-desk/search-member/healthcard" id="search-form-1" class="needs-validation" novalidate>
            <div class="input-group">
        ...
        <div class="col-sm-12 col-md-10 offset-md-1 text-center mb-5 d-none" id="search-by-name">
          <form method="POST" action="<?php echo base_url(); ?>hc-provider-front-desk/search-member/name" id="search-form-2" class="needs-validation" novalidate>
            <div class="input-group">
