    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>hc-provider-front-desk/loa-requests/approved" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>hc-provider-front-desk/loa-requests/completed" role="tab">
              <span class="hidden-sm-up"></span>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#approvedLoaTable').DataTable({
            ...
            ajax: {
                url: `${baseUrl}hc-provider-front-desk/loa-requests/approved/fetch`,
                type: "POST",
    ...
    function viewLoaInfo(loa_id) {
        $.ajax({
        url: `${baseUrl}hc-provider-front-desk/loa-requests/approved/view/${loa_id}`,
        type: "GET",
