    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>hc-provider-front-desk/loa-requests/disapproved" role="tab">
              <span class="hidden-sm-up"></span>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#disapprovedLoaTable').DataTable({
            ...
            ajax: {
                url: `${baseUrl}hc-provider-front-desk/loa-requests/disapproved/fetch`,
                type: "POST",
    ...
    function viewLoaInfo(req_id) {
        $.ajax({
            url: `${baseUrl}hc-provider-front-desk/loa-requests/disapproved/view/${req_id}`,
            type: "GET",
