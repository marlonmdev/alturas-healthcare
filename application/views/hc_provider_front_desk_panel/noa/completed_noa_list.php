        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <li class="nav-item">
                    <a
                    class="nav-link"
                    href="<?php echo base_url(); ?>hc-provider-front-desk/noa-requests/approved"
                    role="tab"
                    ><span class="hidden-sm-up"></span>
                ...
                <li class="nav-item">
                    <a
                    class="nav-link"
                    href="<?php echo base_url(); ?>hc-provider-front-desk/noa-requests/disapproved"
                    role="tab"
                    ><span class="hidden-sm-up"></span>
                    ...
                    href="<?php echo base_url(); ?>hc-provider-front-desk/noa-requests/completed"
                    role="tab"
                    ><span class="hidden-sm-up"></span>
...
<script>
    ...
    $(document).ready(function() {
        ...
        ajax: {
            url: `${baseUrl}hc-provider-front-desk/noa-requests/completed/fetch`,
            type: "POST",
