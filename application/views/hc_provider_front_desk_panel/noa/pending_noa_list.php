    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>hc-provider-front-desk/noa-requests/pending" role="tab">
...
<script>
    ...
    $(document).ready(function() {
        ...
        ajax: {
            url: `${baseUrl}hc-provider-front-desk/noa-requests/pending/fetch`,
            type: "POST",
    ...
    function viewNoaInfo(noa_id) {
        $.ajax({
            url: `${baseUrl}hc-provider-front-desk/noa-requests/view/${noa_id}`,
            type: "GET",
