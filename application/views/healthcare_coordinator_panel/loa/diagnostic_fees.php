      ...
      <div class="row">
        ...
        ?>
          <div class="row pb-4">
            ...
            <div class="col-lg-4">
              ...
              <input class="form-control fw-bold ct-qty" type="number" name="quantity[]" value="1" min="1" oninput="calculateDiagnosticTestBilling(`<?php echo $remaining_balance ?>`)" readonly>
            </div>
          </div>
        <?php 
          endforeach;
        ...
        <div class="col-4 pt-2 pb-2">
          <div class="input-group">
            ...
            <input type="number" class="form-control" name="medicines" id="medicines" value="<?php echo $fees['medicines'] ?>" min="0" oninput="calculateDiagnosticTestBilling('<?php echo $remaining_balance ?>')">
          </div>
        </div>
