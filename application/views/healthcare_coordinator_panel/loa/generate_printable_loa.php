        ...
        <div class="ms-auto text-end">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Print LOA</li>
            </ol>
          </nav>
        </div>
      </div>
            ...
            <div class="grid-body">
              ...
              <div class="row">
                <table>
                  ...
                  <tr>
                    <td colspan="2" style="padding: 0 20px 0 20px;"><div class="my-3" style="border:0.5px solid #585858;"></div></td>
                  </tr>
                    ...
                    <td colspan="2" style="padding: 0 20px 0 20px;">
                      ...
                      <tr>
                        ...
                        <td class="ls-1" style="padding: 0 20px 0 0;vertical-align:baseline">
                          ...
                          Name: <?= $row['contact_person'] ? $row['contact_person'] : 'None' ?><br>
                          Address: <?= $row['contact_person_addr'] ? $row['contact_person_addr'] : 'None' ?><br>
                          Contact No.: <?= $row['contact_person_no'] ? $row['contact_person_no'] : 'None' ?><br>
                          <br><br>
                      ...
                      <tr>
                        ...
                        <td class="ls-1" style="padding:0 20px 0 0;text-align:justify;">
                          ...
                          <i class="mdi mdi-chevron-right fs-4"></i><span class="fw-bold"><?= $row['attending_physician'] ? $row['attending_physician'] : 'None' ?></span>
                        </td>
                      </tr>
