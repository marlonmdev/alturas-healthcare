                ...
                <table>
                  <tr>
                    <td class="ls-1" style="padding-left:20px;">
                      ...
                      <?php
                        $expires = strtotime('+1 week', strtotime($row['request_date']));
                        $valid_until = date('F d, Y', $expires);
                      ?>
                      LOA Number : <strong><?= $row['loa_no'] ?></strong><br>
                      Approved On : <strong><?= date('F d, Y', strtotime($row['request_date'])) ?></strong><br>
                  ...
                  <tr>
                    ...
                    <td class="ls-1" style="padding: 0 20px 0 0;vertical-align:baseline;">
                      ...
                      Contact No.: <?= $row['contact_person_no'] ? $row['contact_person_no'] : 'None' ?>
                      <br><br>
