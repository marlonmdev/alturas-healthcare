  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-12 d-flex no-block align-items-center">
        <h4 class="page-title ls-2">HEALTHCARE ADVANCE</h4>
              ...
              <table class="table table-hover table-responsive" id="ledgertable">
                <thead class="fs-6">
                  <tr>
                    ...
                    <th style="background-color: #00538C; color: white;">WORK RELATED</th>
                    <th style="background-color: #00538C; color: white;">ADMISSION DATE</th>
                    <th style="background-color: #00538C; color: white;">HOSPITAL BILL</th>
