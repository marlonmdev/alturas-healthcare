  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-12 d-flex no-block align-items-center">
        <h4 class="page-title ls-2">HEALTHCARE ADVANCE REQUEST</h4><h4 style="color:green">(Approved)</h4>
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>healthcare-coordinator/healthcare_advance/view_healthcare_advance_approved" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>healthcare-coordinator/healthcare_advance/view_healthcare_advance_disapproved" role="tab">
              <span class="hidden-sm-up"></span>
