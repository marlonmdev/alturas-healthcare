<div class="page-wrapper">
  ...
  <div class="container-fluid">
    ...
    <form id="performedLoaConsultInfo" method="post" action="<?php echo base_url();?>healthcare-coordinator/loa/billed/consultation_schedule_submit" class="needs-validation" novalidate>
      <div class="row">
