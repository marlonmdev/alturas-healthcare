            ...
            <div class="modal-body">
                <div class="row">
                    <ul class="list-unstyled">
                        <li class="text-secondary">
                            ...
                            Patient Name: <span class="fw-bold text-dark fs-5" id="bill-fullname"></span>
                            </span>
                        </li>

                        <li class="text-secondary">
                            <span class="ls-1 fs-5">
                            HealthCare Provider: <span class="fw-bold text-dark fs-5" id="bill-hp-name"></span>
                            </span>
                        </li>
                    </ul>
                </div>
                <div class="row justify-content-center pt-2">
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody id="service-table" class="text-center">
