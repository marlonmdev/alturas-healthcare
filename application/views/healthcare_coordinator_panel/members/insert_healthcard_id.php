        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title ls-2">Upload Scanned Healthcard ID </h4>
                  ...
                  <form method="post" action="<?= base_url() ?>healthcare-coordinator/members/approved/insert-hc-id" id="insertScannedIdForm" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="emp-id" id="emp-id">
                        ...
                        <div class="col-lg-8 pt-1">
                            <input type="text" class="form-control text-danger fs-5 fw-bold" name="emp-name" id="emp-name" placeholder="Employee Name"readonly>
                        </div>
                        ...
                        <em class="text-danger colored-label pb-2fs-5">[ Image must not exceeds 5MB ] </em>
                    <div class="row pt-3">
