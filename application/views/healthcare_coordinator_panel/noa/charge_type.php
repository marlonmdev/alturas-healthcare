...
<div class="modal fade" id="charge_type_modal_not_affiliated" tabindex="-1" data-bs-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container">
          <form method="post" action="<?php echo base_url(); ?>healthcare-coordinator/noa/pending/submit_charge_type_not_affiliated" id="UpdateChargeTypeNotAffiliated">
            <div class="row mb-4">
              <input type="hidden" name="token" value="<?= $this->security->get_csrf_hash() ?>">
              <input type="hidden" name="noa_id" id="noa_id">
              <div class="col-6 pt-3">
                <label class="colored-label fs-5">Select Type :</label>
            ...
            <div class="col pt-3 pb-3">
              ...
              <input class="form-control" id="hospital_bill" readonly>
            </div>
