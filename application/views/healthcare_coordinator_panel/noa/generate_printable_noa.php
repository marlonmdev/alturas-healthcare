              ...
              <div class="request-title">
                <div class="row">
                  <div class="col-xs-12 d-flex justify-content-center align-items-center">
                    <img src="<?= base_url(); ?>assets/images/HC_logo.png" alt="Alturas Healthcare Logo" height="70" width="200">
                  </div>
                </div>
              </div>
              <div class="row">
                <table>
                  ...
                  <tr>
                    ...
                    <td class=" fs-6" style="padding: 0 20px 0 0;">
                      ...
                      <br><span style="margin-left:85px;text-align:center;">Company Physician</span>
                    </td>
                  </tr>

                  <tr>
                    <td colspan="2" style="padding: 0 10px 0 10px;">
                      <div class="my-1" style="border:0.2px solid #585858;"></div>
                    </td>
                  </tr>
                </table>
