            ...
            <div class="table-responsive">
              <table class="table table-hover table-fit" id="companyDoctorsTable">
                <thead>
                  <tr>
                    <th class="fw-bold">#</th>
                    <th class="fw-bold">Doctor's Name</th>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $("#companyDoctorsTable").DataTable({
      ajax: {
        url: `${baseUrl}healthcare-coordinator/setup/company-doctors/fetch`,
  ...
  function editCompanyDoctor(doctor_id) {
    $.ajax({
      url: `${baseUrl}healthcare-coordinator/setup/company-doctors/edit/${doctor_id}`,
      type: "GET",
      success: function(response) {
      ...
      buttons: {
        confirm: {
          ...
          action: function() {
            $.ajax({
              type: 'GET',
              url: `${baseUrl}healthcare-coordinator/setup/company-doctors/delete/${doctor_id}`,
              data: {
                doctor_id
              },
              dataType: "json",
