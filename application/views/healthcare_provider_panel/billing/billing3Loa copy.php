            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        <img class="img-account-profile rounded-circle img-responsive mt-5 mb-2" src="<?= base_url() . 'uploads/profile_pics/' . $user_info['member']->photo ?>" height="auto" alt="Member Photo"><br>
                        <div class="mt-2">
                            <strong><?= $user_info['member']->first_name . ' ' . $user_info['member']->middle_name. ' ' . $user_info['member']->last_name ?></strong>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row d-flex justify-content-center align-items-center">
                            ...
                            <div class="col-md-5 px-4 py-4 text-center">
                                ...
                                <span>
                                    ...
                                    <div v-else>
                                        <button class="btn btn-success" :disabled='isSubmitBilling' @click="addToDb()">Bill</button>
                                    </div>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="container" style="padding-left: 8%;margin-top:3%; padding-right:8%;">
                            <table id="myTable" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <button class="btn btn-primary" type="button" @click="inActiveReview()">
                                            Edit
                                        </button>
                                    </th>
                                </tr>
