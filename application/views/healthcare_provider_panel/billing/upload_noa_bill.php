...
<div class="page-wrapper">
    ...
    <div class="container-fluid" id="container-div">
        <form action="<?php echo base_url();?>healthcare-provider/billing/bill-noa/upload-pdf/submit" id="pdfBillingForm" enctype="multipart/form-data">
            <input type="hidden" name="token" value="<?= $this->security->get_csrf_hash(); ?>">
            <input type="hidden" name="noa-id" id="bill-noa-id" value="<?= $noa_id ?>">
            <div class="card">
