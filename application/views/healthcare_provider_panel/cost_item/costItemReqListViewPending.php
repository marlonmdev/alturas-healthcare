        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url(); ?>healthcare-provider/cost-item/cost-item-requisistion-list/pending">Pending</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="<?php echo base_url(); ?>healthcare-provider/cost-item/cost-item-requisistion-list/approved">Approved</a>
                    </li>
                </ul>
                <br>
