    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>healthcare-provider/noa-requests/billed" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <!-- <li class="nav-item">
            <a class="nav-link" href="< echo base_url(); ?>healthcare-provider/noa-requests/completed" role="tab">
              <span class="hidden-sm-up"></span>
