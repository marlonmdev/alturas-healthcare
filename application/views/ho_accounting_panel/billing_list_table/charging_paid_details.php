...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        ...
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title"><i class="mdi mdi-format-line-style"></i>Paid Charging Details</h4>
        ...
        <div class="row">
            ...
            <div class="col-2 pb-1 pt-3 offset-6">
                <div class="input-group">
                    <a href="<?php echo base_url(); ?>head-office-accounting/charging/business-unit/paid" type="submit" class="btn btn-dark" data-bs-toggle="tooltip" title="Click to Go Back">
...
<script>
        ...
        $(document).ready(function(){
            let chargingTable = $('#detailsTable').DataTable({
                ...
                ajax: {
                    url: `${baseUrl}head-office-accounting/charging/business-units/details/paid/fetch`,
                    type: "POST",
                    data: function(data) {
