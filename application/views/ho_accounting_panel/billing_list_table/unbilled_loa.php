...
<div class="page-wrapper">
            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover" id="unbilledLoaTable">
                            <thead>
                                <tr>
    ...
    const baseUrl = "<?php echo base_url(); ?>";
        $(document).ready(function(){
            let unbilledLoaTable = $('#unbilledLoaTable').DataTable({
            ...
            ajax: {
                url: `${baseUrl}head-office-accounting/billing-list/unbilled_loa/fetch`,
                type: "POST",
                data: function(data) {
            ...
            $('#hospital-filter').change(function(){
                unbilledLoaTable.draw();
            });
         });

         function viewLoaInfo(loa_id) {
            $.ajax({
            url: `${baseUrl}healthcare-provider/loa-requests/unbilled_loa/view/${loa_id}`,
            type: "GET",
