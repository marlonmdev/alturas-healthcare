                ...
                <div class="row mt-3">
                  <div class="col-6">
                    <ul class="list-unstyled">
                      <li class="text-secondary">Issued To:
                        <span class="ls-1 border-secondary border-2 border-bottom pb-1">
                          <?= $bill['first_name'].' '.$bill['middle_name'].' '.$bill['last_name'].' '.$bill['suffix'] ?>
                        </span>
                      </li>

                      <li class="text-secondary mt-2">Issued By:
                        <span class="ls-1 border-secondary border-2 border-bottom pb-1">
                          <?= $bill['billed_by'] ?>
                        </span>
                      </li>
                  ...
                  <div class="col-md-4" style="margin-left: 90px">
                    <ul class="list-unstyled">
                      <li class="text-secondary">Issued On:
                        <span class="ls-1 border-secondary border-2 border-bottom pb-1">
                          <?= date('m/d/Y', strtotime($bill['billed_on'])) ?>
                        </span>
                      </li>

                      <li class="text-secondary mt-2">Healthcare Provider: 
