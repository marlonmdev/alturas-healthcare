  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-12 d-flex no-block align-items-center">
        <h4 class="page-title ls-2"><i class="mdi mdi-format-float-none"></i> For Audit</h4>
        <div class="ms-auto text-end">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Head Office IAD</li>
              <li class="breadcrumb-item active" aria-current="page">For Audit</li>
            </ol>
          </nav>
        </div>
      </div>
  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="card shadow">
          <div class="card-body">
            <div class="">
              <table class="table table-hover table-responsive" id="AuditedTable">
...
<script>
 function redirectPage(route, seconds){
  ...
  $(document).ready(function() {
    let matchedTable = $('#AuditedTable').DataTable({
      processing: true,
      serverSide: true,
      order: [],
      ...
      ajax: {
        url: '<?php echo base_url();?>head-office-iad/biling/for-audit/fetch',
        type: "POST",
