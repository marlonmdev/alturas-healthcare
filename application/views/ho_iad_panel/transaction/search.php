  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-12 d-flex no-block align-items-center">
        <h4 class="page-title">Summary of Billing</h4>
        ...
        <div class="col-12">
          <div class="card shadow">
            <div class="border border-2 border-dark"></div>
              <div class="card-body">
                <h4 class="card-title text-center ls-1">Search to View Transaction Record</h4>
                <div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-sm-8 offset-sm-2 mt-3 mb-5">
                  <div class="input-group">
                    ...
                    <select class="form-select" name="search_select" id="search-select">
											...
											<option value="healthcard">Employee No.</option>
                ...
                <div class="col-6 offset-3 mb-5 d-none" id="search-by-healthcard">
                  <form method="POST" action="<?php echo base_url(); ?>head-office-iad/transaction/search_by_healthcard" id="search-form-1" class="needs-validation" novalidate>
                    <div class="input-group">
											<input type="hidden" name="token" value="<?= $this->security->get_csrf_hash(); ?>">
											<input type="text" class="form-control" name="employee_no" placeholder="Enter Employee No."  aria-describedby="btn-search" required>
