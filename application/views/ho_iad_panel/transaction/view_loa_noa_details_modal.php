<div class="modal fade" id="viewLOANOAdetailsModal" tabindex="-1" data-bs-backdrop="static" style="height:100%">
            ...
            <div class="modal-body">
                <table class="table table-sm">
                    <tr class="border-secondary border-2 border-0 border-top border-bottom">
                        <td><span class="">Member's Fullname : <span class="fw-bold fs-5" id="member-fullname"></span></span></td>
                ...
                <table class="table table-sm">
                    <tr class="border-secondary border-2 border-0 border-top border-bottom">
                        ...
                        <td><span class="">Billed by : <span class="fw-bold fs-5" id="billed-by"></span></span></td>
                    ...
                    <tr class="border-secondary border-2 border-0 border-top border-bottom">
                        <td><span class="fw-bold">Current MBL : </span></td>
                        <td></td>
                        <td></td>
                        <td><span class="fs-5" id="max-benefit"></span></td>
                    </tr>
                    <tr class="border-secondary border-2 border-0 border-top border-bottom">
                        <td><span class="fw-bold">Hospital Net Bill : </span></td>
                        <td></td>
                        <td><span class="fs-5" id="net-bill"></span></td>
                    </tr>
                    <tr class="border-secondary border-2 border-0 border-top border-bottom">
                        <td><span class="fw-bold">Personal Charge  : </span></td>
                        <td></td>
                        <td><span class="fs-5" id="personal-charge"></span></td>
                    </tr>
                    <tr class="border-secondary border-2 border-0 border-top border-bottom">
                        <td><span class="fw-bold">Company Charge  : </span></td>
                        <td><span class="fs-5" id="company-charge"></span></td>
                        <td></td>
                    </tr>
                    <tr class="border-secondary border-2 border-0 border-top border-bottom">
                        <td><span class="fw-bold">Cash Advance : </span></td>
                        <td><span class="fs-5" id="cash-advance"></span></td>
                        <td></td>
                    </tr>
                    <tr class="border-secondary border-2 border-0 border-top border-bottom">
                        <td><span class="fw-bold">Total Payable : </span></td>
                        <td><span class="fs-5 text-info" id="total-payable"></span></td>
                        <td><span class="fs-5 text-info" id="totals-payable"></span></td>
                    </tr>
                    <tr class="border-secondary border-2 border-0 border-top border-bottom">
                        <td><span class="fw-bold">Remaining MBL : </span></td>
                        <td></td>
                        <td></td>
                        <td><span class="fs-5" id="remaining-mbl"></span></td>
                    </tr>
                </table>
            </div>
