             ...
             <input type="hidden" name="token" value="<?= $this->security->get_csrf_hash(); ?>">
                <div class="container">
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="row col-lg-4 pb-3 pt-2" id="payment-num-div">
                            <label class=" text-dark fw-bold ms-2 fs-5">Payment Number: </label>
                        </div>
                        <div class="col-lg-8" id="payment-num-div-input">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control text-dark fs-5" name="cv-date" id="cv-date" readonly>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control text-dark fs-5" name="amount-paid" id="amount-paid" oninput="validateNumberInputs()" readonly>
                        </div>
