    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="nav nav-tabs mb-4" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>member/requested-emergency-loa/billed" role="tab">
              <span class="hidden-sm-up"></span>
...
<script>
  ...
  $(document).ready(function() {
    $("#memberbilledNoa").DataTable({
      ajax: {
        url: `${baseUrl}member/requested-emergency-loa/billed/fetch`,
  ...
  const viewNoaInfoModal = (req_id) => {
    $.ajax({
      url: `${baseUrl}member/requested-emergency-loa/view/approved/${req_id}`,
      type: "GET",
