    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="card shadow">
          <div class="card-body">
            <form method="post" action="<?php echo base_url(); ?>member/requested-emergency-loa/update/<?= $this->myhash->hasher($row['noa_id'], 'encrypt') ?>" enctype="multipart/form-data" class="mt-2" id="editNoaRequestForm">
              ...
              <div class="row">
                <div class="col-sm-12 mb-2 d-flex justify-content-start">
                  ...
                  <a href="<?php echo base_url(); ?>member/requested-emergency-loa/pending" class="btn btn-danger">
...
<script type="text/javascript">
  ...
  const redirectPage = `${baseUrl}member/requested-emergency-loa/pending`;
