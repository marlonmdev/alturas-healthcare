    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-3">
          <div class="col-sm-12">
            <a class="btn btn-dark me-2" href="<?php echo base_url(); ?>member/requested-emergency-loa/approved">
            ...
            <button class="btn btn-danger ls-1" onclick="printDiv('#printableDiv')"><i class="mdi mdi-printer"></i> Print Emergency LOA</button>
          </div>
        </div>
