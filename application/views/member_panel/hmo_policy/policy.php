      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block flex-column flex-sm-row align-items-left">
              <h4 class="page-title ls-2">Alturas Healthcare Terms and Conditions</h4>
        ...
        <div class="container">
          <div class="row mt-4 mb-4">
              ...
              <p class="fs-5 ps-3">This Data Privacy Policy is to serve you better when you avail of our services and inform you of how your personal data is collected, used, and secured by AGC. Please read our Data Privacy Policy carefully.</p>

              <h2 class="mt-4 fs-5">PERSONAL DATA COLLECTED</h2>

              <p class="fs-5 ps-3">We may collect, store, and use your personal data directly when you provide it in instances when you register, apply, create or modify any account in any of AGC’s website, mobile applications, customer support, customer surveys, apply for employment, or in connection with any other activities, services, features, or resources we make available on this app via any means (e.g., tablet, cellphone, etc.).</p>

              <ol>
                <li class="fs-5 ms-3">Collected Personal Information (PI) thru this app:
                  <ul>
                    <li>Name</li>
                    <li>Birthday</li>
                    <li>Mobile number</li>
                ...
                <li class="fs-5 ms-3">Collected Sensitive Personal Information (SPI) thru this website / app
                  <ul>
                    <li>Gender</li>
                    <li>Civil Status</li>
              ...
              <p class="fs-5 ps-3">AGC reserves the right to modify this Privacy Policy at any time, so please review it frequently. Changes and clarifications will take effect immediately upon their posting on the website.</p>

              <p class="fs-5 ps-3">If we make material changes to this policy, we will notify you here that it has been updated, so that you are aware of what information we collect, how we use it, and under what circumstances, if any, we use and/or disclose it.</p>

              <p class="fs-5 ps-3">If our store is acquired or merged with another company, your information may be transferred to the new owners so that we may continue to sell products to you.</p>

              <h2 class="mt-4">CONTACT US</h2>

              <p class="fs-5 ps-3">If you have any questions or concerns about this Privacy Policy, please contact us:</p>
