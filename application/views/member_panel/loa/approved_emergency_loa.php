    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>member/requested-emergency-noa/approved" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>member/requested-emergency-noa/disapproved" role="tab">
              <span class="hidden-sm-up"></span>
...
<script>
  ...
  $(document).ready(function() {
    $("#memberApprovedNoa").DataTable({
      ajax: {
        url: `${baseUrl}member/requested-emergency-noa/approved/fetch`,
  ...
  const viewNoaInfoModal = (req_id) => {
    $.ajax({
      url: `${baseUrl}member/requested-emergency-noa/view/approved/${req_id}`,
      type: "GET",
