    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="nav nav-tabs mb-4" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>member/requested-emergency-noa/completed" role="tab">
              <span class="hidden-sm-up"></span>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#memberCompletedNoa').DataTable({
      ...
      ajax: {
        url: `${baseUrl}member/requested-emergency-noa/completed/fetch`,
        type: "POST",
  ...
  const viewNoaInfoModal = (req_id) => {
    $.ajax({
      url: `${baseUrl}member/requested-emergency-noa/view/completed/${req_id}`,
      type: "GET",
