    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="nav nav-tabs mb-4" role="tablist">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>member/requested-emergency-noa/pending" role="tab">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>member/requested-emergency-noa/approved" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url(); ?>member/requested-emergency-noa/disapproved" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>member/requested-emergency-noa/billed" role="tab">
              <span class="hidden-sm-up"></span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>member/requested-emergency-noa/paid" role="tab">
              <span class="hidden-sm-up"></span>
...
<script>
  ...
  $(document).ready(function() {
    $("#memberDisapprovedNoa").DataTable({
      ajax: {
        url: `${baseUrl}member/requested-emergency-noa/disapproved/fetch`,
  ...
  const viewNoaInfoModal = (req_id) => {
    $.ajax({
      url: `${baseUrl}member/requested-emergency-noa/view/disapproved/${req_id}`,
      type: "GET",
