      ...
      <div class="row d-flex align-items-center justify-content-center h-100" id="login-div">
        <div class="col-sm-8 col-md-6 col-lg-4 col-xl-4">
          <div class="text-center mb-3">
            <img src="<?= base_url() ?>assets/images/padlock-6.svg" id="lock-icon" class="img-fluid mx-auto" alt="Lock Icon">
          </div>
          <div class="mb-3">
            <h3 class="text-center"><strong><span class="login-title">Alturas Healthcare</span></strong></h3>
          </div>
