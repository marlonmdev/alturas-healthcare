          ...
          <div class="row mb-2">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card-box bg-blue">
                ...
                <a href="<?php echo base_url(); ?>super-admin/healthcare-providers" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card-box bg-green">
                ...
                <a href="<?php echo base_url(); ?>super-admin/members/approved" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card-box bg-orange">
                ...
                <a href="<?php echo base_url(); ?>super-admin/loa/requests-list" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card-box bg-red">
                ...
                <a href="<?php echo base_url(); ?>super-admin/noa/requests-list" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
