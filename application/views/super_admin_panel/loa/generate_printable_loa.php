    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-3">
          ...
          <div class="col-sm-12">
            <a class="btn btn-dark me-2" href="<?php echo base_url(); ?>super-admin/loa/requests-list/approved">
        ...
        <div class="card shadow px-3 py-3">
          <div class="row" id="printableDiv" style="background:#ffff;padding:20px 30px;">
            <div class=" col-xs-12">
