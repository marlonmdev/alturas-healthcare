        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" action="<?= base_url() ?>super-admin/setup/company-doctors/register/submit" id="registerDoctorForm" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group  d-flex justify-content-end mb-2">
                      <button type="button" class="btn btn-success" onclick="setDefaultPassword()" data-bs-toggle="tooltip" title="Use Default Password"><i class="bx bxs-key"></i> Set Password</button>
                    </div>
