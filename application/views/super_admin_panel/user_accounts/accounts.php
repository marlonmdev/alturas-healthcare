...
<script>
  ...
  $(document).ready(function() {
    let userTable = $('#userAccountsTable').DataTable({
      ...
      ajax: {
        url: `${baseUrl}super-admin/accounts/fetch`,
        type: "POST",
        data: function(data) {
  ...
  function getMemberValues(emp_id) {
    ...
    $.ajax({
      url: `${baseUrl}super-admin/accounts/member/search/${emp_id}`,
      method: "GET",
      success: function(response) {
  ...
  function viewUserAccount(user_id) {
    ...
    $.ajax({
      url: `${baseUrl}super-admin/accounts/view/${user_id}`,
      type: "GET",
      success: function(response) {
        const res = JSON.parse(response);
        const {
  ...
  function editUserAccount(user_id) {
    $.ajax({
      url: `${baseUrl}super-admin/accounts/edit/${user_id}`,
      type: "GET",
      success: function(response) {
        const res = JSON.parse(response);
  ...
  function changeUserAccountStatus(user_id) {
    ...
    $.ajax({
      type: 'GET',
      url: `${baseUrl}super-admin/accounts/change-status/${user_id}`,
      data: {
        user_id
      },
      dataType: "json",
      ...
      buttons: {
        confirm: {
          ...
          action: function() {
            $.ajax({
              type: 'GET',
              url: `${baseUrl}super-admin/accounts/reset-password/${user_id}`,
              data: {
                user_id
              },
              dataType: "json",
      ...
      buttons: {
        confirm: {
          ...
          action: function() {
            $.ajax({
              type: 'GET',
              url: `${baseUrl}super-admin/accounts/delete/${user_id}`,
              data: {
                user_id
              },
              dataType: "json",
