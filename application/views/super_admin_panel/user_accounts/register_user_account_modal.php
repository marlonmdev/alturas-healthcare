              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="container-fluid">
                    <form method="POST" action="<?php echo base_url(); ?>super-admin/accounts/register/submit" class="mt-3" id="registerAccountForm">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                          <label class="colored-label"><i class="bx bx-health icon-red"></i> Password</label><br>
                      ...
                      <div class="row">
                        <div class="col-sm-12 mb-2 d-flex justify-content-end">
                          <button type="submit" class="btn btn-primary"><i class="mdi mdi-content-save"></i> REGISTER</button>
                          &nbsp;&nbsp;
