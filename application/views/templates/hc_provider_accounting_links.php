<li class="sidebar-item">
  <a
    class="sidebar-link"
    href="<?php echo base_url(); ?>hc-provider-accounting/dashboard"
    aria-expanded="false" >
...
<li class="sidebar-item <?php echo $this->uri->segment(2) == "loa-requests" ? "selected" : ""; ?>" onclick="toggleSelected(this)">
  <a
    class="sidebar-link"
    href="<?php echo base_url(); ?>hc-provider-accounting/loa-requests/pending"
    aria-expanded="false">
...
<li id="hc-list-soa-tab" class="sidebar-item <?php echo $this->uri->segment(2) == 'patient_soa' ? 'selected' : ""; ?>" onclick="toggleSelected(this)">
  <a class="sidebar-link sidebar-link" href="<?php echo base_url(); ?>hc-provider-accounting/patient_soa/soa-list" aria-expanded="false">
