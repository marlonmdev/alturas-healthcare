...
function MultiSelectTag (el, customs = {shadow: false, rounded:true}) {
    if (document.getElementById(el).hasAttribute('data-multi-select-initialized')) {
        const elementsToRemove = document.getElementsByClassName('mult-select-tag');
        ...
        // Loop through the array and remove each element along with its subtree
        elementsArray.forEach(element => element.parentNode.removeChild(element));
        // Return the existing instance to avoid creating multiple elements
        // return;
    }
    var element = null
    var options = null
    ...
    init()
    document.getElementById(el).setAttribute('data-multi-select-initialized', 'true');
    function init() {
