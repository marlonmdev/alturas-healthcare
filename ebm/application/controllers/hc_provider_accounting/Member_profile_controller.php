...
class Member_profile_controller extends CI_Controller {
    ...
    function memberProfile() {
        ...
        $this->load->view('hc_provider_accounting_panel/member_profile/member_profile.php');
    ...
    function memberProfileInfoById() {
        ...
        if ($member) {
            $this->load->view('templates/header', $data);
            $this->load->view('hc_provider_accounting_panel/member_profile/member_profile_info.php', array('member' => $member));
            $this->load->view('templates/footer');
        } else {
    ...
    function memberProfileInfoMbl() {
        ...
        $data['user_role'] = $this->session->userdata('user_role');
        $this->load->view('templates/header', $data);
        $this->load->view('hc_provider_accounting_panel/member_profile/member_profile_info_mbl.php', array('member' => $member));
        $this->load->view('templates/footer');
    }
}
