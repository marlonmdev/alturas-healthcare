  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-secondary ls-1">DISAPPROVE REQUEST</h5>
        ...
        <form method="post" id="loaDisapproveForm">
          ...
          <div class="row mt-2">
            <div class="col-sm-12 mb-sm-0 d-flex justify-content-end">
              <button type="submit" class="btn btn-danger me-2"><i class="mdi mdi-content-save"></i> SUBMIT</button>
