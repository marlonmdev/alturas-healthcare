      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="<?= base_url(); ?>healthcare-coordinator/loa/request-loa/submit" class="mt-2" id="loaRequestForm" enctype="multipart/form-data">
...
<script>
  ...
  function getMemberValues(emp_id) {
    $.ajax({
      url: `${baseUrl}healthcare-coordinator/loa/member/search/${emp_id}`,
      method: "GET",
      success: function(response) {
