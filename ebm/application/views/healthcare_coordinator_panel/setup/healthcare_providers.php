...
<script>
  ...
  $(document).ready(function() {
    $("#healthCareProvidersTable").DataTable({
      ajax: {
        url: `${baseUrl}healthcare-coordinator/setup/healthcare-providers/fetch`,
  ...
  function viewHealthCareProvider(hp_id) {
    $.ajax({
      url: `${baseUrl}healthcare-coordinator/setup/healthcare-providers/view/${hp_id}`,
      type: "GET",
      success: function(response) {
  ...
  function editHealthCareProvider(hp_id) {
    $.ajax({
      url: `${baseUrl}healthcare-coordinator/setup/healthcare-providers/edit/${hp_id}`,
      type: "GET",
      success: function(response) {
        const res = JSON.parse(response);
        const {
      ...
      buttons: {
        confirm: {
          ...
          action: function() {
            $.ajax({
              type: 'GET',
              url: `${baseUrl}healthcare-coordinator/setup/healthcare-providers/delete/${hp_id}`,
              data: {
                hp_id
              },
              dataType: "json",
