    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="card shadow">
          <div class="card-header bg-secondary text-white ls-2 fs-5">Change Password</div>
            <div class="card-body">
              <form method="post" action="<?php echo base_url(); ?>head-office-iad/transaction/update_password" class="mt-2" id="passwordUpdateForm">
                ...
                <div class="offset-4">
                  <button type="submit" class="btn btn-success me-1"><i class="mdi mdi-update"></i> UPDATE</button>
                  <button type="reset" class="btn btn-danger"><i class="mdi mdi-delete-forever"></i> CLEAR</button>
                </div>
              </form>
            </div>
          </div>
        ...
        <div class="col-lg-6">
          <div class="card shadow">
            <div class="card-header bg-secondary text-white ls-2 fs-5">Change Username</div>
            <div class="card-body">
              <form method="post" action="<?php echo base_url(); ?>head-office-iad/transaction/update_username" class="mt-2" id="usernameUpdateForm">
								<input type="hidden" name="token" value="<?= $this->security->get_csrf_hash() ?>">
								<div class="mb-3">
