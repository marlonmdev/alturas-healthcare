    ...
    <div class="row">
      ...
      <nav class="navbar navbar-expand-md navbar-light">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url(); ?>member/requested-emergency-noa/pending" role="tab">
...
<script>
  ...
  $(document).ready(function() {
    $("#memberPendingNoa").DataTable({
      ajax: {
        url: `${baseUrl}member/requested-emergency-noa/pending/fetch`,
  ...
  const viewNoaInfoModal = (req_id) => {
    $.ajax({
      url: `${baseUrl}member/requested-emergency-noa/view/pending/${req_id}`,
      type: "GET",
